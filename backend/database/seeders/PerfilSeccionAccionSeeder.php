...
class PerfilSeccionAccionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            $permisos_por_perfil = [
                'administrador' => ['Equipos', 'Jugadores', 'Usuarios', 'Retos', 'Centros', 'Perfiles', 'Ciclos', 'Estudios', 'Familias', 'Inscripciones', 'Incidencias', 'Partidos', 'Torneo', 'Publicaciones', 'Imagenes'],
