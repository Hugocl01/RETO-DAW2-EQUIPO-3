      ...
      <div className="container">
        ...
        >
          ...
          <div className="flex-grow-0" id="logo">
            <Link
              to="/"
              className="d-flex justify-content-flex-start align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none"
            >
          ...
          >
            <ul className="nav col-13 col-lg-auto me-lg-auto mb-3 d-flex justify-content-center align-items-center mb-md-0">
              <li>
                <Link
                  to="/"
                  className={`nav-link px-2 link-body-emphasis ${isActive(
                    "/"
                  )}`}
                  id="elementoMenu"
                >
          ...
          <div className="flex-grow-0" id="iniciarSesion">
            ...
            {seguridad.user ? (
              ...
              <Link
                to="/login"
                className="btn btn-primary text-black ms-2 text-white"
              >
                Iniciar sesión
              </Link>
            )}
